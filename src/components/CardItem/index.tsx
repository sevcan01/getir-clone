  ...
  return (
    ...
    <View
      ...
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        <Image
          style={{ width: height * 0.09, height: height * 0.09,borderWidth:0.4,borderColor:'lightgray',borderRadius:8 }}
          source={{ uri: product.image }}
          />
        <View style={{ marginLeft: 8 }}>
          <Text style={{ fontSize: 13, fontWeight: "600",maxWidth:width*0.44 }}>
            {product.name}
          </Text>
      ...
      <View style={{shadowOpacity:0.4, shadowColor:'gray', flexDirection:'row',justifyContent:'space-around', alignItems:'center', width:width*0.21,borderColor:'lightgrey', borderWidth:0.5,height:height*0.037,borderRadius:10}}>
        <TouchableOpacity onPress={()=>removeFromCard(product)} style={{flex:1,alignItems:'center',}}>
            <Text>-</Text>
        </TouchableOpacity>
