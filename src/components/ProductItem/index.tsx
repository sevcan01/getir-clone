...
const index = ({item, addItemToCard}:productItemType) => {
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity onPress={()=>{addItemToCard(item)}} style={{alignItems:'center', justifyContent:'center', shadowRadius:3.8,shadowOpacity:0.5, width:30,height:30,borderWidth:0.3,borderBlockColor:'lightgrey', backgroundColor:'white',position:'absolute',right:-6,top:-6,borderRadius:6}}>
