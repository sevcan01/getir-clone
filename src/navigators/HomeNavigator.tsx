...
const MyStack = ({ navigation, route , cardItems, clearCart}:{cardItems:{product:Product,quantity:number}[], clearCart:()=> void}) => {
...
function HomeNavigator({ navigation, route , cardItems,clearCart}:{clearCart:()=>void}) {
  return <MyStack navigation={navigation} route={route} cardItems={cardItems} clearCart={clearCart}/>;
}
